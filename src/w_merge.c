...
static void DoMerge(void)
{
    ...
    for (i=0; i<iwad.numlumps; ++i)
    {
        ...
        {
            case SECTION_NORMAL:
                if (!w3sstrncasecmp(lump->name, "F_START", 8))
                {
            ...
            case SECTION_FLATS:
                ...
                if (!w3sstrncasecmp(lump->name, "F_END", 8))
                {
    ...
    for (i=0; i<pwad.numlumps; ++i)
    {
        ...
        switch (current_section)
        {
            case SECTION_NORMAL:
                if (!w3sstrncasecmp(lump->name, "F_START", 8)
                 || !w3sstrncasecmp(lump->name, "FF_START", 8))
                {
                    current_section = SECTION_FLATS;
                }
                else if (!w3sstrncasecmp(lump->name, "S_START", 8)
            ...
            case SECTION_FLATS:
                ...
                if (!w3sstrncasecmp(lump->name, "FF_END", 8)
                 || !w3sstrncasecmp(lump->name, "F_END", 8))
                {
                    // end of section
                    current_section = SECTION_NORMAL;
                }
